...
HOLDER_COLOR_LOWER_THRESHOLD_HSV = np.array([90, 150, 50])   # Lower bound of blue, adjusted for darker shades
HOLDER_COLOR_UPPER_THRESHOLD_HSV = np.array([150, 255, 255])  # Upper bound of blue, adjusted to cover more shades of blue
