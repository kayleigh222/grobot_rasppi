...
HOLDER_COLOR_LOWER_THRESHOLD_HSV = np.array([80, 50, 50])   # Lower bound for all blues (covering a broader range)
HOLDER_COLOR_UPPER_THRESHOLD_HSV = np.array([160, 255, 255])  # Upper bound for all blues
