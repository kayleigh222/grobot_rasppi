...
DISTANCE_BELOW_TARGET_HOLDER_TO_SLIDE_ACROSS = 29 # pixels - max vertical distance between holders to be able to slide across
...
try:
    ...
    set_up_top_conveyor()
    additional_distance_to_push_tray_across_threshold = 300
    ...
    target_location_for_bottom_tray = int(bottom_conveyor_leg_top_right_x - 100) 
    ...
    print('finding corners for left contour')
    corners_left = extract_holder_corners(image, bottom_holder_left['contour'], 16, 0.04, 45)
