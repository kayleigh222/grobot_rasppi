...
try:
    ...
    target_location_for_bottom_tray = int(bottom_conveyor_leg_top_right_x - 350) 
    ...
    while(distance_below_target < -22 or distance_below_target > 0):
